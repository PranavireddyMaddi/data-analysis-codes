...
data = pd.read_csv("D://CQ//Python//datasets//iris.csv") #importing the dataset 
...
x_train,x_test,y_train,y_test= train_test_split(df_x,df_y,test_size=0.3) #dividing the data randomly
y_test.head()
...
rf = RandomForestClassifier(criterion="entropy",n_estimators=15,oob_score=True) # n_estimator number of tree in the forest 
